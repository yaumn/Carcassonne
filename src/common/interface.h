...
/**
 * \brief Stucture for 2D coordinates
 */
...
/**
 * \brief Lists all the possible places of the meeples on a card
 */
enum place {
  ...
  POS_EAST_NORTH, //!< {EN}
  POS_CENTER,     //!< C
  LAST_POS,       //!< number of positions
};

/**
 * \brief List of the game's cards
...
enum card_id {
  ...
  LAST_CARD,                /*!< number of cards */
};

/**
 * \brief The allowed_positions table lists for each card the allowed
 ...
 * \param card: the id of the card that has been drawn
 * \param previous_moves: ordered list of previous moves starting from the last
